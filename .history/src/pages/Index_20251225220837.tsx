...
const Index = () => {
  ...
  // --- CORRECTION : Synchronisation stable ---
  // On ne remplit les champs QUE lorsque le panneau s'ouvre (showConfig passe à true)
  // On ne met PAS 'config' dans les dépendances pour éviter le reset pendant la frappe
  useEffect(() => {
    if (showConfig) {
  ...
  const saveConfig = () => {
    // Cas 1: Si l'adresse est vide, on efface la config adresse mais on garde l'heure
