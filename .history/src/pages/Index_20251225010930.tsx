        ...
        <div className="container py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
  variant={homeLocation ? "default" : "outline"}
  size="icon"
  onClick={() => {
    // Définit la position actuelle comme "Maison / Dépôt"
    setHomeAddress(driverLocation.lat, driverLocation.lng);
    // Un petit feedback visuel simple (tu peux utiliser ton toast ici si tu veux)
    alert("Position actuelle définie comme point de départ/retour !");
  }}
  title="Définir ma position comme Dépôt/Maison"
  className="mr-2"
>
