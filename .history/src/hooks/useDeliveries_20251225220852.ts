...
export const useDeliveries = () => {
  ...
  // CORRECTION MAJEURE ICI : On utilise useCallback pour éviter que la fonction change
  ...
  // CORRECTION MAJEURE ICI : On utilise useMemo pour stabiliser l'objet config
